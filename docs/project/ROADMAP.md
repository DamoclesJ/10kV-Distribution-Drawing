...
8. WP-EM-07A Transformer & Pole-Device Grounding Amendment — Implementation Complete / Review Passed / Windows Automated Tests Passed / Windows Professional Acceptance Fix-2 In Progress / Closure Blocked
